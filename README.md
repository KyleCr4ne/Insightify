...
Регуляризации при вычислении градиента используется для контроля за весами модели в процессе обучения. Данная реализация предполгает использование L1 или L2 регуляризации. Для этого, при указание регуляризатора в ходе вычисления градиента дополнительно минимизурется штраф за высокие показатели вектора весов. Таким образом функция потерь принимает вид:
